...
below.  The most important option is the B<run> option which sets the mode
...
is the exit code of a failing command).
...
STATUS is one of the strings:
   ...
   succ       STATUS of an empty string, or the string 'succ'.
              ...
              the empty string is ever assigned as STATUS.
